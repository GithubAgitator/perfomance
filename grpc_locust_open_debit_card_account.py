...
class GreaterCardsDepositScenarioUser(User):
    ...
    deposit_cards: AccountsGatewayGRPCClient
    ...
    def on_start(self) -> None:
        ...
        self.creater_deposit = build_account_locust_gateway_grpc_client(self.environment)
    ...
    @task
    def creaters_deposit(self):
        self.creater_deposit.open_deposit_card(self.create_user_response.user.id)
