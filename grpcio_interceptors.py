...
intersept_channel = grpc.intercept_channel(channel, SimpleLoggingInterceptor())
stub = UsersGatewayServiceStub(intersept_channel)

request = GetUserRequest(id="71adc078-31c1-400c-9164-4e252ab6d950")
